...
import { createFood, getFoodsByChef, getFoods,getFoodsByCategory,updateFoodImage, getFoodsByCountry, getChefsByFoodCountry, getFoodDetails } from '../controllers/foodController.js';
...
router.get('/:chefId', getFoodsByChef);
router.get('/', getFoods);
